...
| 项目 | 一页纸总结 |
|---|---|
| 文件定位 | AI 一人公司的 12 模块知识框架。 |
| 适合对象 | 需要从 AI 基础、模型、Prompt、RAG、Agent、开发一路学到商业化的人。 |
| 核心内容 | AI 基础、模型选型、Prompt、RAG、Agent、AI 应用开发、SaaS 商业化、运营、用户研究、增长、合规、决策模板。 |
| 立即行动 | 按 P0 模块优先学：AI 基础、模型选型、Prompt、RAG、应用开发、用户研究、风险合规。 |
| 关键产出 | AI 产品技术地图、模型选型表、RAG Demo、Agent 设计卡、MVP Demo、用户洞察卡。 |
| 关联文件 | `06-30-day-roadmap-and-product-ideas.md` 将该框架转成 30 天行动计划。 |

## PDF 补充重点

- AI 基础补充：生成式 AI / 判别式 AI、Temperature、Top-p、幻觉原因、输入-处理-输出-反馈链路。
- 模型选型补充：SFT、LoRA、蒸馏、多模型混合调用、显存消耗、本地部署 vs 云端调用。
- Prompt 补充：零样本、少样本、Few-shot、自我一致性、固定 JSON 输出、批量 Prompt 设计。
- RAG 补充：Rerank、混合检索、增量更新、PDF/Word/网页解析、RAG 评估指标。
- Agent 补充：短期/长期记忆、多 Agent 协作、人机协同卡点。
- 开发补充：环境变量、接口限流、日志监控、移动端适配、Docker 部署。
- 商业化补充：额度限制、续费转化、用户分层、盈利模型测算。
- 运营补充：单人 SOP、精力管理、版本迭代机制、项目台账。
