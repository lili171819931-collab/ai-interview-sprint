...
| 项目 | 一页纸总结 |
|---|---|
| 文件定位 | GitHub 成熟开源项目复刻清单，按应用场景和技术类型分类。 |
| 适合对象 | 想通过复刻成熟项目快速掌握 AI App、RAG、Agent、Workflow、Eval、多模态和 SaaS 基础设施的人。 |
| 核心内容 | AI Chat、RAG、Agent、自动化、多模型网关、Eval、向量库、多模态、OCR、SaaS 模板、MCP、优秀作者和复刻路线。 |
| 立即行动 | 选择路线 A/B/C/D 之一，克隆对应项目并在 1 天内跑通本地 Demo。 |
| 关键产出 | 可复刻项目清单、作者/团队地图、4 条一人公司快速复刻路线。 |
| 关联文件 | `09-ai-skills-and-apps-catalog.md` 从 Skill 和 App 角度补充工具选择。 |
