...
const DICT: Record<string, { zh: string; en: string }> = {
  ...
  "dev.subtitle": { zh: "新 Skill 接入平台的标准方式：注册后自动进入 Registry / 搜索 / Agent Tool Registry，无需开发页面", en: "Standard way to add Skills: once registered they auto-enter Registry / Search / Agent Tool Registry — no pages to build" },
