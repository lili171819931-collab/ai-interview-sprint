...
type Tab = "analysis" | "diagram" | "director" | "agent" | "expert" | "prompt" | "report";
      ...
      {result && (
        <>
          ...
          <div className="panel p-5">
            ...
            {tab === "expert" && (result.seed ? <ExpertCockpit project={result.seed} /> : <LiveSourcePanel repo={result.repo} mode="expert" />)}
