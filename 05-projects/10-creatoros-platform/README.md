...
- **多源真实抓取**：`npm run crawl:hot` 抓取 Hacker News / B站 / 微博 / Google Trends（Reddit/知乎视网络可用性），来源渠道 + 原帖链接真实可打开。
- **18 大赛道分类**：AI/科技、商业/创业、职场、财经、汽车、教育、女性成长、生活方式、健康、旅行、美食、时尚、消费、娱乐、游戏、体育、国际/时政、综合 —— **每个赛道 ≥20 条热点帖**（真实 + 明确标注的演示补齐），按热度排列。
- 每条热点显示：来源渠道 / 原帖链接（点击打开）/ 地区 / 热度 / 点赞 / 评论 / 播放分享 / 增长 / Live·Demo 标注，支持「拆解」弹窗（原帖 + 同类赛道 Top10 + 一键进入创作）。
- 排序：热度最高 / 点赞最高 / 讨论最多 / 分享最多；国内 / 海外 / 全球切换。
